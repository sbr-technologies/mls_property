...
<div class="email-templates-index">
    ...
    GridView::widget([
        ...
        'columns' => [
            ...
            'subject',
            'created_at:datetime',
            ['class' => 'yii\grid\ActionColumn', 'template' => '{view} {send-to-subscriber} {schedule-for-subscriber}',
                'buttons' => [
                    'send-to-subscriber' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-send"></span>', $url, [
                                    'title' => Yii::t('yii', 'Send to Subscribers'),
                        ]);
                    },
                    'schedule-for-subscriber' => function ($url, $model) {
                        return Html::a('<i class="fa fa-clock-o"></i>', $url, [
                                    'title' => Yii::t('yii', 'Send To Subscriber Groups'),
                        ]);
                    }
                        ],
