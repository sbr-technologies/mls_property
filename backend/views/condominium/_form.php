        ...
        <div role="tabpanel" class="tab-pane" id="landMark">
            <div class="col-sm-12 form-sec">
                ...
                <div class="row">
                    <div class="">
                        <div class="col-sm-4">
                            <?= $form->field($model, 'lot_size')->textInput(['maxlength' => true, 'placeholder' => 'e.g 100']) ?>
                        </div>
                        <div class="col-sm-4">
                            <?= $form->field($model, 'building_size')->textInput(['maxlength' => true, 'placeholder' => 'e.g 100']) ?>
                        ...
                        <div class="col-sm-4">
                            <?= $form->field($model, 'house_size')->textInput(['maxlength' => true, 'placeholder' => 'e.g 100', 'disabled' => true]) ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="">
                        <div class="col-sm-3">
                            <?= $form->field($model, 'no_of_room')->dropDownList($range,['prompt' => 'Select No of Rooms', 'disabled' => true]) ?>
                        </div>
                        <div class="col-sm-3">
