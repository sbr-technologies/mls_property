...
<div class="property-view">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#locationInfo" aria-controls="location-info" role="tab" data-toggle="tab">Basic & Location Infor</a></li>
        <li role="presentation"><a href="#landMark" aria-controls="land-mark" role="tab" data-toggle="tab">Property Info & Land Mark</a></li>
        <li role="presentation"><a href="#priceInfo" class="inactive" aria-controls="price-info" role="tab" data-toggle="tab">Price & Other Info</a></li>
        <li role="presentation"><a href="#photoVirtual" aria-controls="price-info" role="tab" data-toggle="tab">Property Photos, Virtual Tour & Docs</a></li>
        ...
        <li role="presentation"><a href="#metaInfo" aria-controls="meta-info" role="tab" data-toggle="tab">Meta Info</a></li>
        ...
        <li role="presentation"><a href="#openHouses" class="inactive" aria-controls="open-Houses" role="tab" data-toggle="tab">Open House</a></li>
        <li role="presentation"><a href="#contactInfo" class="inactive" aria-controls="open-Houses" role="tab" data-toggle="tab">Contacts Info</a></li>
        <li role="presentation"><a href="#showingInfo" class="inactive" aria-controls="open-Houses" role="tab" data-toggle="tab">Showing Information</a></li>
    </ul>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="form-group col-sm-4">
                                <label for="">Bedroom Range:</label>
                                <?= $model->bedroom_range ?>
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="">Bathroom Range:</label>
                                <?= $model->bathroom_range ?>
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="">Toilet Range:</label>
                                <?= $model->toilet_range ?>
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="">Parking Range:</label>
                                <?= $model->parking_range ?>
                            </div>
                        </div>
                    </div>
