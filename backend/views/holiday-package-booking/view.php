...
?>
<div class="holiday-package-booking-view">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="guest_info">
                <?php Pjax::begin(['id' => 'pjax-container']); ?>
                    <?= GridView::widget([
                        'dataProvider' => $holidayGuestDataProvider,
                        'columns' => [
                            ...
                            [
                                ...
                                'buttons' => [
                                    'view'      =>  function ($url,$model) {
                                                        ...
                                                        $title = 'Details';
                                                        return Html::a('<span class="'.$class .'"></span>', ['holiday-booking-guest/view', 'id' => $model->id],
                                                            ['data-target' => '#mls_bs_modal_one', 'data-toggle' => 'modal', 'title' => $title]);
                                                    },
                                    'update'    =>  function ($url,$model) {
                                                        $class = 'fa fa-pencil showModalButton';
                                                        $title = 'Edit';
                                                        return Html::a('<span class="'.$class.'"></span>',['holiday-booking-guest/update', 'id' => $model->id],
                                                            ['data-target' => '#mls_bs_modal_one', 'data-toggle' => 'modal', 'title' => $title]);
                                                    },
                                    'delete'    =>  function ($url,$model) {
                                                        ...
                                                        $title = 'Delete';
                                                        return Html::a(
                                                            '<span class="'.$class.'"></span>',Url::to(['holiday-booking-guest/delete', 'id' => $model->id]), 
                                                            [
                                                                'title'         => $title,
                                                                'data-pjax'     => '0',
                                                                'onclick' => "if (confirm('Are you sure?')) {
                                                                    $.ajax('".Url::to(['holiday-booking-guest/delete', 'id' => $model->id])."', {
                                                                        type: 'POST'
                                                                    }).done(function(data) {
