...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#newsDetails" aria-controls="newsDetails" role="tab" data-toggle="tab">News Details</a></li>
    <li role="presentation"><a href="#newsImageInfo" aria-controls="newsImageInfo" role="tab" data-toggle="tab">News Image</a></li>
</ul>
...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="newsDetails">
        <div class="news-form">
            ...
            <?= $form->field($model, 'news_category_id')->dropDownList(ArrayHelper::map(NewsCategory::find()->active()->all(), 'id', 'name'), ['prompt' => 'Select News Category']) ?>
