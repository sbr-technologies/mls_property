                        ...
                        [
                          ...
                          'buttons'     => [
                                            'delete'    =>  function ($url,$model) {
                                                                ...
                                                                $title = 'Delete';
                                                                return Html::a(
                                                                    '<span class="'.$class.'"></span>',Url::to(['hotel-owner-service-category-mapping/delete', 'id' => $model->id]), 
                                                                    [
                                                                        'title'         => $title,
                                                                        'data-pjax'     => '0',
                                                                        'onclick' => "if (confirm('Are you sure?')) {
                                                                            $.loading();
                                                                            $.ajax('".Url::to(['hotel-owner-service-category-mapping/delete', 'id' => $model->id])."', {
                                                                                type: 'POST'
                                                                            }).done(function(data) {
