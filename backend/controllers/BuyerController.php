...
class BuyerController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        $worksheetModel = BuyerWorkSheet::findOne(['user_id' => $model->id]);
        if(empty($worksheetModel)){
            $worksheetModel = new BuyerWorkSheet();
            $worksheetModel->user_id = $model->id;
        }
        ...
        if ($worksheetModel->load(Yii::$app->request->post())) {
            if($worksheetModel->save(false)){
                return $this->redirect(['view', 'id' => $model->id]);
            }
        }
        return $this->render('update', [
            'model' => $model, 'worksheetModel' => $worksheetModel
        ]);
    }
