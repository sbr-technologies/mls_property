...
<tbody>
    <tr style="background:#f5f5f5;">
        <td style="padding: 15px;">
            ...
            <p style="margin:0; padding:0;"><strong>Approve Property Showing Request</strong></p>
            <p class="confirmation" style="padding-bottom: 0;">Your Property Showing Request has been approved.</p>
            <p>Your Property send Request Details, given below :</p>
            <p>Name : <?= Html::encode($propertyRequest->name) ?> <br>
