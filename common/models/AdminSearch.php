...
class AdminSearch extends User
{
    ...
    {
        return [
            [['id', 'profile_id', 'gender', 'phone_verified', 'email_verified', 'email_activation_sent', 'total_reviews', 'membership_id', 'is_login_blocked', 'failed_login_cnt', 'created_by', 'updated_by', 'created_at', 'updated_at'], 'integer'],
            [['salutation', 'first_name', 'middle_name', 'last_name', 'username', 'short_name', 'location', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'mobile1', 'calling_code', 'dob', 'zip_code', 'tagline', 'profile_image_file_name', 'profile_image_extension', 'email_activation_key', 'otp', 'ip_address', 'street_address', 'street_number', 'city', 'country', 'social_id', 'social_type', 'slug', 'timezone', 'login_blocked_at', 'status'], 'safe'],
