...
/**
 * This is the model class for table "{{%about_buyer}}".
 *
 * @property string $id
 ...
 */
class AboutBuyer extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return AboutBuyerQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new AboutBuyerQuery(get_called_class());
    }
}
