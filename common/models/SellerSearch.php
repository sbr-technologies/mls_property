 ...
 */
class SellerSearch extends User
{
    public $searchstring;
    /**
     * @inheritdoc
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'sellerID', $this->sellerID])
        ...
        $query->orFilterWhere(['like', 'first_name', $this->searchstring])
            ->orFilterWhere(['like', 'last_name', $this->searchstring])
