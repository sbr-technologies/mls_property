...
class m170111_095311_create_timezone_master extends Migration
{
    public function up()
    {
        $this->createTable('{{%timezone_master}}', [
            'id' => $this->bigPrimaryKey(),
            'label' => $this->string(75)->notNull(),
            'name' => $this->string(125)->notNull(),
        ]);
        $this->batchInsert('{{%timezone_master}}', ['label', 'name'], [
    ...
    {
       $this->dropTable('{{%timezone_master}}');
    }
