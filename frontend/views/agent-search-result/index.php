...
//\yii\helpers\VarDumper::dump($agentArr,12,1); exit;
?>
<div class="row">
  <div class="col-sm-9">
    ...
    <div class="agent-listing-sec">
      ...
      foreach ($agentArr as $agent) {
          ...
          <div class="agent-listing">
            ...
            <h3><a href="<?= Url::to(['user/view-profile', 'slug' => $agent->slug]) ?>"><?= ucwords($agent->fullName) ?></a></h3>
            <?php 
                ...
                <div class="agent-listing-right-left">
                  ...
                  foreach ($agentSocialMediaArr as $socialMedia) {
                      if ($socialMedia->name == 'facebook') {
                          ?>
                          <a href="<?= Url::to($socialMedia->url) ?>"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                          <?php
