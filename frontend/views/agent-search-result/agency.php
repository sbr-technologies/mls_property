                  ...
                  <div class="agent-listing-right-top">
                    <div class="agent-listing-sale-sold">
                      <?php
                        ...
                        $lastPropertyData = Property::find()->where(['user_id' => $agentsQuery])->orderBy(['id' => SORT_ASC])->active()->one();
                      ?>
                    </div>
                ...
                <div class="agent-listing-right-left">
                  ...
                  foreach ($agencySocialMediaArr as $socialMedia) {
                      if ($socialMedia->name == 'facebook') {
                          ?>
                          <a href="<?= Url::to($socialMedia->url) ?>" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                          <?php
