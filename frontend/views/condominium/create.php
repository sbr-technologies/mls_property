            ...
            <div class="manage-profile-form-sec new-property-form-sec">
                <div class="manage-profile-tab-bar">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#priceInfo" class="inactive" aria-controls="price-info" role="tab">Price & Other Info</a></li>
                        ...
                        <li role="presentation"><a href="#openHouses" class="inactive" aria-controls="open-Houses" role="tab">Open House</a></li>
                        <li role="presentation"><a href="#contactInfo" class="inactive" aria-controls="open-Houses" role="tab">Sales Contact Info</a></li>
                        <li role="presentation"><a href="#showingInfo" class="inactive" aria-controls="open-Houses" role="tab">Showing Information</a></li>
                    </ul>
                </div>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="locationInfo">
                            <div class="col-sm-12 form-sec">
                                ...
                                <div class="row">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <?= $form->field($model, 'building_name')->textInput(['class' => 'form-control txt_building_name', 'placeholder' => 'Building Name'])?>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="dv_building_information">
                                    <h5>Building Information:</h5>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <?= $form->field($model, 'price_range')->textInput(['maxlength' => true,'class'=> 'form-control', 'placeholder' => ' e.g. $100,000 - $200,000']) ?>
                                        </div>
                                        <div class="col-sm-6">
                                            <?= $form->field($model, 'bedroom_range')->textInput(['maxlength' => true,'class'=> 'form-control', 'placeholder' => 'e.g. 2 - 3']) ?>
                                        </div>
                                        <div class="col-sm-6">
                                            <?= $form->field($model, 'bathroom_range')->textInput(['maxlength' => true,'class'=> 'form-control', 'placeholder' => 'e.g. 1 - 2']) ?>
                                        </div>
                                        <div class="col-sm-6">
                                            <?= $form->field($model, 'toilet_range')->textInput(['maxlength' => true,'class'=> 'form-control', 'placeholder' => 'e.g. 1 - 2']) ?>
                                        </div>
                                        <div class="col-sm-6">
                                            <?= $form->field($model, 'parking_range')->textInput(['maxlength' => true,'class'=> 'form-control', 'placeholder' => 'e.g. 1 - 2']) ?>
                                        </div>
                                        <div class="col-sm-6">
                                            <?= $form->field($model, 'floors')->textInput(['maxlength' => true,'class'=> 'form-control', 'placeholder' => 'e.g. 10']) ?>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-sm-12 form-sec">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <?= $form->field($model, 'house_size')->textInput(['maxlength' => true,'class'=> 'form-control', 'placeholder' => 'e.g 100', 'disabled' => true]) ?>
...
<!--                                        <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-sm-3">
                                            <?= $form->field($model, 'no_of_room')->dropDownList($roomRange,['prompt' => 'Select No of Rooms', 'disabled' => true]) ?>
                                        </div>
                                        <div class="col-sm-3">
                                            <?= $form->field($model, 'no_of_bathroom')->dropDownList($range,['prompt' => 'Select No of Bathroom', 'disabled' => true]) ?>
                                        </div>
                                        <div class="col-sm-3">
                                            <?= $form->field($model, 'no_of_toilet')->dropDownList($range,['prompt' => 'Select No of Toilet', 'disabled' => true]) ?>
                                        </div>
                                        <div class="col-sm-3">
                                            <?= $form->field($model, 'no_of_garage')->dropDownList($range,['prompt' => 'Select No of Garage', 'disabled' => true]) ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <?= $form->field($model, 'no_of_boys_quater')->dropDownList($range,['prompt' => 'Select No of Boys Quater', 'disabled' => true]) ?>
                                        </div>
                                        <div class="col-sm-4">
                                        </div>
                                        <div class="col-sm-4">
...
$js = "$(function(){
        ...
        $('.chk_is_multi_units_apt').on('change', function(){
            if($(this).is(':checked')){
                $('#property-parent_id').prop('disabled', false);
                $('#property-building_name').prop('disabled', false);
            }else{
                $('#property-parent_id').prop('disabled', true);
                $('#property-building_name').prop('disabled', true);
            }
        });
