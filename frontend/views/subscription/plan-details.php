              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="form-group">
                        <form name="frm_duration" action="<?= Url::to(['subscription/plan-details']);?>">
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="paypal-payment">
              <div class="col-sm-9 form-sec">
                <p><a href="<?= Url::to(['subscription/process-express-checkout', 'selected_plan_id' => $model->id, 'duration' => $duration]);?>" class="btn btn-primary btn-lg">Paypal Payment</a></p>
              </div>
            </div>
...
<?php }else{?>
    <a href="<?= Url::to(['subscription/subscribe', 'selected_plan_id' => $model->id]);?>" class="btn btn-primary btn-lg">Subscribe</a>
<?php }?>
      </div>
