...
$this->registerJsFile(
    '@web/public_main/js/property_search.js',
    ['depends' => [
        \yii\web\JqueryAsset::className(),
        \yii\bootstrap\BootstrapPluginAsset::ClassName()
        ]
...
<div class="property-menu-bar">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <form action="<?= Url::to(['/search-result'])?>" role="search" class="frm_search_result_page_search">
                    ...
                    <input type="hidden" class="hid_view_type" value="list" />
                    <input type="hidden" class="hid_require_json" value="n" />
                    ...
                    <input type="hidden" class='hid_property_listing_base' value="<?= Url::to(['realestate/search'])?>" />
...
//                                                    
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <label for="">Name of Condominium / Development:</label>
                                                        <?= Html::textInput('condominium', $condominium, ['class' => 'form-control txt_filter_condominium search_item', 'placeholder' => 'e.g. Mercury ICON Luxury Homes']) ?>
                                                    </div>
                                                </div>
                                            </div>
