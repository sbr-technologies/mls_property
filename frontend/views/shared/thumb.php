            ...
            <div style="background:#eee; border:1px #d5d5d5 solid; border-radius:2px; display:inline-block; margin-bottom:10px; width:100%; position:relative;">
                <div style="padding:0; position:relative; background: #fff; width:44%; float:left;">
                    ...
                    <div style="background:rgba(255,255,255,0.8); display:inline-block; width:100%;">
                        ...
                        <div style="float:left; font-size:12px; padding:5px 10px; ">
                            ...
                            <p style="float:left; margin:2px 0 0 6px; line-height:30px;"><a href="<?= Url::to(['agency/view', 'slug' => $agency->slug], true)?>"><?= $agency->name?></a></p>
                        </div>
                        <?php }?>
                ...
                <div style="width:50%; float:left; padding:1% 2%;">
                    ...
                    <ul style="width:100%; display:inline-block; padding:0; margin:5px 0 10px;">
                        <li style="color:#666; border-right:1px #d5d5d5 solid; padding:4px 10px; text-align:center; float:left; font-weight:normal; font-size:13px; list-style:none; margin: 0;"><strong><img src="<?= Yii::$app->params['homeUrl']?>/images/icons/bd.png" alt=""></strong> bd <span style="display:block; font-weight:600; color:#000;"><?= $model->no_of_room?></span></li>
                        <li style="color:#666; border-right:1px #d5d5d5 solid; padding:4px 10px; text-align:center; float:left; font-weight:normal; font-size:13px; list-style:none; margin: 0;"><strong><img src="<?= Yii::$app->params['homeUrl']?>/images/icons/ba.png" alt=""></strong> ba <span style="display:block; font-weight:600; color:#000;"><?= $model->no_of_bathroom?></span></li>
                        <li style="color:#666; border-right:1px #d5d5d5 solid; padding:4px 10px; text-align:center; float:left; font-weight:normal; font-size:13px; list-style:none; margin: 0;"><strong><img src="<?= Yii::$app->params['homeUrl']?>/images/icons/tl.png" alt=""></strong> tl <span style="display:block; font-weight:600; color:#000;"><?= $model->no_of_toilet?></span></li>
                        <li style="color:#666; border-right:1px #d5d5d5 solid; padding:4px 10px; text-align:center; float:left; font-weight:normal; font-size:13px; list-style:none; margin: 0;"><strong><img src="<?= Yii::$app->params['homeUrl']?>/images/icons/gr.png" alt=""></strong> gr <span style="display:block; font-weight:600; color:#000;"><?= $model->no_of_garage?></span></li>
                        <li style="color:#666; padding:4px 10px; text-align:center; float:left; font-weight:normal; font-size:13px; list-style:none; margin: 0;"><strong><img src="<?= Yii::$app->params['homeUrl']?>/images/icons/sq.png" alt=""></strong> SqM <span style="display:block; font-weight:600; color:#000;"><?= $model->house_size?></span></li>
                    </ul>
                </div>
            </div>
    </div>
