...
$notFoundTemplate = '<div class="suggestion_location_notfound"><p>Unable to find any address for selected query.</p></div>';
$headerTemplate = '<div class="location-suggestion-header"><i class="fa fa-map-marker"></i> Addresses</div>';

echo Typeahead::widget([
    'name' => 'location_suggestion', 
    'options' => ['placeholder' => 'e.g . 1234, Inner Block Circle, 210'],
//    'pluginOptions' => ['highlight' => true],
    'dataset' => [
        [
            'remote' => [
                'url' => Url::to(['/location-suggestion/address']) . '?q=%QUERY',
                'wildcard' => '%QUERY',
                'cache' => false
            ],
...
//            console.log(data);
            $('.realestate_search_address').val(data.value);
        }",
