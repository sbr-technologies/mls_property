            ...
            <div class="property-listing-sec listing_item" data-id="<?= $property->id?>">
                <div class="property-listing">
                    ...
                    <div class="col-sm-5 property-listing-right">
                        ...
                        <h2>
                            <?php echo Yii::$app->formatter->asCurrency($property->price); ?>
                        </h2>
                        <h4>
                        ...
                        <br><br><span style="margin:0px"><i class="fa fa-calendar" aria-hidden="true"></i> added : <?= date("dS F Y",$property->created_at) ?></span>
                    </div>
