...
$this->title = "Buying Discussion";

$discussionArr  = DiscussionPost::find()->where(['category_id' => 1])->active()->all();
            ...
            <div class="row">
                <div class="col-sm-9">
                    <div class="buying-selling-titlebar">
                        <h2>Latest in Buying</h2>
                        <select name="">
                            <option>Latest in Buying </option>
                            <option>Popular in Buying</option>
                        </select>
                    </div>
