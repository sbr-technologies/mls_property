...
$this->title = 'Create Holiday Package Itinerary';
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Add New Holiday Package Itinerary</h1>
        <ol class="breadcrumb">
            <li><a href="javascript:void(0)"><i class="fa fa-home" aria-hidden="true"></i> Holiday Management</a></li>
            <li class="active">Add New Holiday Package Itinerary</li>
        </ol>
    </section>
    <!-- Content Title Sec -->
                ...
                <?= $form->field($itineraryModel, 'holiday_package_id')->hiddenInput(['maxlength' => true,'value' => $holiday_package_id])->label(false) ?>
                    <div class="tab-content">
                        ...
                        <div class="form-group text-center">
                            ...
                            <?= Html::button($itineraryModel->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Update'), ['class' => $itineraryModel->isNewRecord ? 'btn btn-default red-btn bnt_save_package_itinerary' : 'btn btn-primary gray-btn']) ?>
                        </div>
                    </div>
                <?php ActiveForm::end(); ?>
            </div>
