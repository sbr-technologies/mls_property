                                    ...
                                    <div class="item">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="listing-con">
                                                ...
                                                <p class="listing-con-details"><?php echo Yii::$app->language == "ar" ? (!empty($property->title_ar) ? $property->title_ar : $property->title) : $property->title; ?></p>
                                                <div class="clearfix"></div>
                                                <p class="listing-price">
                                                    <?php echo Yii::$app->language == "ar" ? (!empty($property->price_ar) ? $property->price_ar : $property->price) : $property->price; ?> /
