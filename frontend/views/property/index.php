        ...
        <div class="manage-profile-sec">
          <?php
            $gridColumns = [
                ...
                'expired_date:date',
                'daysExpiring',
                ['attribute' => 'market_status', 'noWrap' => true],
                [
                    ...
                    'renew' => function ($url, $model) {
                        ...
                        return Html::a('<span class="glyphicon glyphicon-refresh"></span>', ['/property/renew', 'id' => $model->id, 'cat' => 'index'], ['title' => Yii::t('yii', 'Renew')]);
                    }
                    ],
            ...
            echo GridView::widget([
                ...
                'panel' => [
                    ...
                    'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-home"></i> Property List</h3>',
                ],
            ]);
          ?>
        </div>
