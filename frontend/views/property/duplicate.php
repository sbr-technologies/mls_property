        ...
        <div class="manage-profile-sec">
            ...
            <div class="manage-profile-form-sec new-property-form-sec">
                <div class="manage-profile-tab-bar">
                 ...
                 <?php $form = ActiveForm::begin(['action' => ['property/copy'],'method' => 'post','options' => ['class' => 'frm_geocomplete','id' => 'frm_capture_property_data']]); ?>
...
<!--                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-3">
                                                    <?= $form->field($model, 'street_address')->textInput(['maxlength' => true, 'class' => 'small-height-textarea', 'placeholder' => 'e.g Inner Block street']) ?>
                                                </div>
                                                <div class="form-group col-sm-3">
                                                    <?= $form->field($model, 'street_number')->textInput(['maxlength' => true, 'class' => 'street_number small-height-textarea', 'placeholder' => 'e.g 1234']) ?>
                                                </div>
                                                <div class="form-group col-sm-3">
                                                    <?= $form->field($model, 'appartment_unit')->textInput(['maxlength' => true, 'class' => 'form-control', 'placeholder' => 'e.g 100']) ?>
                                                </div>
                                                <div class="form-group col-sm-3">
...
<!--                                            <div class="col-sm-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <?= Html::activeLabel($item, "[$i][$j]description")?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <?= Html::activeLabel($tempItem, "[$i][$k]description")?>
                        ...
                        <div class="form-group text-center">
                            ...
                            <?= Html::button($model->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Save'), ['class' => $model->isNewRecord ? 'btn btn-primary bnt_copy_property' : 'btn btn-primary bnt_copy_property']) ?>
                        </div>
                    </div>
                <?php ActiveForm::end(); ?>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-12">
                                <?= Html::activeLabel($tempItem, '[curTime][1]description')?>
            ...
            <div class="form-group">
				...
				<?= Html::activeLabel($tempItem, '[curTime][2]name')?>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-12">
                                <?= Html::activeLabel($tempItem, '[curTime][2]description')?>
            ...
            <div class="form-group">
				...
				<?= Html::activeLabel($tempItem, '[curTime][3]name')?>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-12">
                                <?= Html::activeLabel($tempItem, '[curTime][3]description')?>
