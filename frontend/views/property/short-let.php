...
$this->title = 'Short let Property List';
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Short let Property List</li>
        </ol>
    </section>
    <!-- Content Title Sec -->
          ...
          <?php
                ...
                [
                    'class' => '\kartik\grid\ActionColumn',
                        ...
                        'view' => function ($url, $model) {     
                            return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', ['/property/details','id' => $model->id], ['title' => Yii::t('yii', 'delete')]); 
                        },
                        ...
                        'renew' => function ($url, $model) {
                            ...
                            return Html::a('<span class="glyphicon glyphicon-refresh"></span>', ['/property/renew', 'id' => $model->id, 'cat' => 'short-let'], ['title' => Yii::t('yii', 'Renew')]);
                        }
                        ],
            ...
            echo GridView::widget([
                ...
                'panel' => [
                    ...
                    'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-home"></i> Short let Property List</h3>',
                ],
            ]);
          ?>
        </div>
