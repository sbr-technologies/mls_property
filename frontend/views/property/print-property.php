...
<div class="main-wrapper">
    ...
    <div class="pdf-top-part">
        ...
        <div class="top-address-part">
            ...
            <p>
                <?= $agency->mobile ? "<span><b>Phone:</b>". $agency->mobile."</span><br>" : ""; ?>
                <?= $agency->mobile2 ? "<span><b>Phone:</b>". $agency->mobile2."</span><br>" : ""; ?>
                <?= $agency->mobile3 ? "<span><b>Phone:</b>". $agency->mobile3."</span><br>" : ""; ?>
