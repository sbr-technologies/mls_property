...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Rent Property List</li>
        </ol>
    </section>
    <!-- Content Title Sec -->
          ...
          <?php
                ...
                [
                    'class' => '\kartik\grid\ActionColumn',
                        ...
                        'renew' => function ($url, $model) {
                            ...
                            return Html::a('<span class="glyphicon glyphicon-refresh"></span>', ['/property/renew', 'id' => $model->id, 'cat' => 'rent'], ['title' => Yii::t('yii', 'Renew')]);
                        }
                        ],
            ...
            echo GridView::widget([
                ...
                'panel' => [
                    ...
                    'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-home"></i> Rent Property List</h3>',
                ],
            ]);
          ?>
        </div>
