    ...
    <div class="login-box register-box">
        ...
        <div class="login-box-inner">
            ...
            <?php $form = ActiveForm::begin(['id' => 'question_form', 'options' => ['autocomplete' => 'off']]); ?>
                ...
                <input type="hidden" value="<?= $model->id ?>" class="ask_user_id" name="Question[agency_id]" /> 
                <div class="row">
                    <div class="col-sm-12">
                        <!--<img src="<?php // echo $model->getImageUrl(Agency::THUMBNAIL)?>" alt="<?= $model->name?>">-->
                        Get in Touch With <strong><?= $model->name?></strong>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
