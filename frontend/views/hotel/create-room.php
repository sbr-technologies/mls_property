                ...
                <?php $form = ActiveForm::begin(['options' => ['class' => '','id' => 'frm_capture_room_data']]); ?>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group text-center">
                            ...
                            <?= Html::button($roomModel->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Update'), ['class' => $roomModel->isNewRecord ? 'btn btn-default red-btn bnt_save_room' : 'btn btn-primary gray-btn']) ?>
                        </div>
                    </div>
                <?php ActiveForm::end(); ?>
            </div>
