...
?>
<div class="dv_banner_advertisement_info_container">
...
<div class="item">
    ...
    <?= $form->field($banner, "[$i]description")->textarea(['rows' => 4]) ?>
...
<button class="btn_add_banner_advertisement_info" type="button">Add Another</button>