...
$this->title = $location. ' Apartment for Rent - '. Yii::$app->name;
...
<section class="propertymenubar_holder">
    <!-- Property Menu Bar -->
    <?php
    echo $this->render('//shared/_property_search_filtter', ['location' => $location, 'town' => $town, 'state' => $state, 'area' => $area,
                    ...
                    <div class="property-listing-top-title">
                        <div class="col-sm-9">
                            ...
                            <div class="propery-listing-title-bar">
                                ...
                                if (!empty($properties)) {  
                                ?>
                                    <!--<h3 class="pull-left"><?= $location. ' Apartment & Home for Rent'?></h3>-->
                            ...
                            <?php }?>
                                <div class="property-listing">
                                    ...
                                    <div class="col-sm-5 property-listing-right">
                                        ...
                                        <h4>
                                            <?php echo StringHelper::truncate($property->formattedAddress, 50); ?>
                                        </h4>
...
<a href="javascript:void(0)" class="compare-count lnk_compare_property" data-url="<?php echo Url::to(['property/compare-property'],'http') ?>" title="Compare"><i class="fa fa-ioxhost" aria-hidden="true"></i> <span id="totalCntDiv"><?= (isset($compProps)? count($compProps):0)?></span></a>
    ...
    <div class="map-popup-box-list">
        <a href="<%= detail_url %>" target="_blank">
            ...
            <div class="map-popup-box-list-content">
                    ...
                    <p class="map-popup-box-list-content-txt"><span><%= price%></span> <strong>3 bd <i class="fa fa-circle" aria-hidden="true"></i> 1ba <i class="fa fa-circle" aria-hidden="true"></i> 1,456 sq ft</strong></p>
            </div>
        </a>
    </div>
</script>
