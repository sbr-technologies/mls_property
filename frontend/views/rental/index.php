...
$unitLaundryRental    = RentalExtension::find()->where(['in_unit_laundry' => 1])->all();
$poolRental           = RentalExtension::find()->where(['pools' => 1])->all();
$friendlyRental      = RentalExtension::find()->where(['pet_friendly' => 1])->all();
$rentalHomeRental     = RentalExtension::find()->where(['homes' => 1])->all();
$studioRental         = RentalExtension::find()->where(['studio' => 1])->all();
...
echo $this->render('//shared/_property_banner_search', ['type' => 'rental']);
foreach($unitLaundryRental as $unitLaundry){ 
    $unitLaundryProperty[]  =   $unitLaundry->property; 
}
foreach($poolRental as $pool){ 
    $poolProperty[]         =   $pool->property; 
}
foreach($friendlyRental as $friendly){ 
    $friendlyProperty[]     =   $friendly->property; 
}
foreach($rentalHomeRental as $rentalHome){ 
    $rentalHomeProperty[] =   $rentalHome->property; 
}
foreach($studioRental as $studio){ 
    $studioProperty[] =   $studio->property; 
}
                        ...
                        <div class="listing-item-sec">
                            <div class="row">
                                <div id="owl-demo" class="owl-carousel owl-theme">
                                    <?php
                                    foreach ($unitLaundryProperty as $key => $property) {
                                        ?>
                                        <div class="item">
    ...
    <div class="home-listing-sec">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <?php
                    if (!empty($poolProperty)) {

                        ?>
                        <h2>Rentals with Pools </h2>
                        <div class="listing-item-sec">
                            <div class="row">
                                <div id="rental-pools" class="owl-carousel owl-theme">
                                    <?php
                                    foreach ($poolProperty as $poolKey => $poolVal) {
    ...
    <div class="home-listing-sec">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <?php
                    if (!empty($friendlyProperty)) {

                        ?>
                        <h2>Pet-Friendly Rentals  </h2>
                        <div class="listing-item-sec">
                            <div class="row">
                                <div id="pet-friendly" class="owl-carousel owl-theme">
                                    <?php
                                    foreach ($friendlyProperty as $poolKey => $poolVal) {
                                        //\yii\helpers\VarDumper::dump($poolVal->title); exit;
                                        ?>
                                        <div class="item">
                                            <a href="<?php echo Url::to(['property/view', 'slug' => $poolVal->slug]) ?>" class="listing-item-img" >
    ...
    <div class="home-listing-sec">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <?php
                    if (!empty($rentalHomeProperty)) {

                        ?>
                        <h2>Homes For Rent  </h2>
                        <div class="listing-item-sec">
                            <div class="row">
                                <div id="homes-rental" class="owl-carousel owl-theme">
                                    <?php
                                    foreach ($rentalHomeProperty as $poolKey => $poolVal) {
                                        //\yii\helpers\VarDumper::dump($poolVal->title); exit;
                                        ?>
                                        <div class="item">
                                            <a href="<?php echo Url::to(['property/view', 'slug' => $poolVal->slug]) ?>" class="listing-item-img" >
