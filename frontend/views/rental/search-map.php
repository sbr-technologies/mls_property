        ...
        <div class="col-sm-5 property-search-right-outer">
            <div class="property-search-right-sec">
                ...
                <div class="propery-search-title-bar">
                    <a href="<?php echo Url::to(['property/search', 'type' => 'map']) ?>" class="btn btn-default pull-right active">Map</a>
                    <a href="<?php echo Url::to(['property/search', 'type' => 'list']) ?>" class="btn btn-default pull-right">List</a>
                </div>
