            ...
            <div class="manage-profile-form-sec new-property-form-sec">
                <div class="manage-profile-tab-bar">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#propertyFeature" aria-controls="propertyFeature" role="tab" data-toggle="tab">Features</a></li>
                    ...
                    <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-sec-box">
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="item new">
                                                                <div class="form-group col-sm-6">
                                                                    <div class="row">
                                                                        <?= Html::activeHiddenInput($localInfo, '[curTime]id')?>
                                                                        <?= Html::activeHiddenInput($localInfo, '[curTime]lat', ['class' => 'lat_curTime'])?>
                                                                        <?= Html::activeHiddenInput($localInfo, '[curTime]lng', ['class' => 'lat_curTime'])?>
                                                                        <div class="form-group col-sm-12">
                                                                            <?= Html::activeLabel($localInfo, '[curTime]local_info_type_id')?> :
                                                                            <?= Html::activeDropDownList($localInfo, '[curTime]local_info_type_id', ArrayHelper::map(LocationLocalInfoTypeMaster::find()->all(), 'id', 'title'), ['prompt' => 'Select Local Location', 'class' => 'form-control'])?>
                                                                        </div>

                                                                        <div class="form-group col-sm-12">
                                                                            <?= Html::activeLabel($localInfo, '[curTime]title')?>
                                                                            <?= Html::activeTextInput($localInfo, '[curTime]title', ['class' => 'form-control'])?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-sm-6">
                                                                    <div class="row">
                                                                        <div class="form-group col-sm-12">
                                                                            <?= Html::activeLabel($localInfo, '[curTime]location')?>
                                                                            <?= Html::activeTextInput($localInfo, '[curTime]location', ['class' => 'form-control geocomplete_local_info_curTime'])?>
                                                                        </div>
                                                                        <div class="form-group col-sm-12">
                                                                            <?= Html::activeLabel($localInfo, '[curTime]description')?>
                                                                            <?= Html::activeTextarea($localInfo, '[curTime]description', ['class' => 'form-control'])?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="">
                                                                    <?= Html::activeHiddenInput($localInfo, "[curTime]_destroy", ['class' => 'hidin_child_id']) ?>
                                            ...
                                            ?>
                                            <div class="row rental_local_info_container">
                                                
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="form-group text-center">
                                                <button name="" type="button" class="btn_add_rental_property_local_info btn btn-default add-landmark-btn"><span>+</span> Add New Location Local Info</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="price-info">
                            <div class="col-sm-12 form-sec">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <?= $form->field($model, 'property_category_id')->dropDownList(ArrayHelper::map(PropertyCategory::find()->all(), 'id', 'title'), ['prompt' => 'Select Property Category', 'id' => 'property_category_id','class'=>'selectpicker']) ?>
                                        </div>

                                        <div class="col-sm-6">
                                            <?php echo $form->field($model, 'property_type_id')->widget(DepDrop::classname(), [
                                                'data'=>ArrayHelper::map(PropertyType::find()->where(['property_category_id' => $model->property_category_id])->all(), 'id', 'title' ),
                                                'options' => ['id'=>'property_type_id'],
                                                'pluginOptions'=>[
                                                   'depends'=>['property_category_id'],
                                                   'placeholder' => 'Select...',
                                                   'class'=>'selectpicker',
                                                   'url' => Url::to(['/property-type'])
                                                ]
                                           ]); ?>
                                        </div>
                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="rentalPlan">
                            <div class="form-sec-box">
                                <div class="row">
                                    <?php
                                    if(isset($rentalPlanModel) && is_array($rentalPlanModel) && count($rentalPlanModel) > 0){
                                    ?>
                                        <div class="form-sec-box">
                                            <div class="row">
                                                <?php
                                                foreach($rentalPlanModel as $rentalPlan){
                                                ?>
                                                    <div class="item new">
                                                        <div class="form-group col-sm-6">
                                                            <div class="row">
                                                                <?= Html::activeHiddenInput($rentalPlan, '[curTime]id')?>
                                                                <div class="form-group col-sm-12">
                                                                    <?= Html::activeLabel($rentalPlan, '[curTime]rental_plan_id')?>
                                                                    <?= Html::activeDropDownList($rentalPlan, '[curTime]rental_plan_id', ArrayHelper::map(RentalPlanType::find()->all(), 'id', 'name'), ['prompt' => 'Select Plan', 'class' => 'form-control'])?>
                                                                </div>
                                                                <div class="form-group col-sm-12">
                                                                    <?= Html::activeLabel($rentalPlan, '[curTime]name')?>
                                                                    <?= Html::activeTextInput($rentalPlan, '[curTime]name', ['class' => 'form-control'])?>
                                                                </div>
                                                                <div class="form-group col-sm-12">
                                                                    <?= Html::activeLabel($rentalPlan, '[curTime]bed')?>
                                                                    <?= Html::activeTextInput($rentalPlan, '[curTime]bed', ['class' => 'form-control'])?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            <div class="row">
                                                                <div class="form-group col-sm-12">
                                                                    <?= Html::activeLabel($rentalPlan, '[curTime]bath')?>
                                                                    <?= Html::activeTextInput($rentalPlan, '[curTime]bath', ['class' => 'form-control'])?>
                                                                </div>
                                                                <div class="form-group col-sm-12">
                                                                    <?= Html::activeLabel($rentalPlan, '[curTime]size')?>
                                                                    <?= Html::activeTextInput($rentalPlan, '[curTime]size', ['class' => 'form-control'])?>
                                                                </div>
                                                                <div class="form-group col-sm-12">
                                                                    <?= Html::activeLabel($rentalPlan, '[curTime]price')?>
                                                                    <?= Html::activeTextInput($rentalPlan, '[curTime]price', ['class' => 'form-control'])?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="">
                                                            <?= Html::activeHiddenInput($rentalPlan, "[curTime]_destroy", ['class' => 'hidin_child_id']) ?>
                                                            <a data-toggle="tooltip" class="btn btn_check_payment tooltip-test delete_child" title="" data-original-title="<?= Yii::t('app', 'Delete row') ?>"><i class="fa fa-trash-o"></i></a>
                                                        </div>
                                                    </div>
                                    ...
                                    ?>
                                    <div class="row rental_plan_info_container">

                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group text-center">
                                        <button name="" type="button" class="btn_add_rental_plan_info btn btn-default add-landmark-btn"><span>+</span> Add New Rental Plan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <div role="tabpanel" class="tab-pane" id="propertyFeature">
                            <div class="col-sm-12 form-sec">
                                <div class="row">
                                    <h5>Features:</h5>
                                    <div class="form-sec-box">
                                        <div class="row">
                                                        ...
                                                        ?>
                                                            <div class="item new">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <?= Html::activeDropDownList($feature, "[$i]feature_master_id", ArrayHelper::map(RentalFeatureMaster::find()->all(), 'id', 'name'), ['prompt' => 'Select Feature', 'class' => 'form-control'])?>
                                                                </div>
                                            ...
                                            $tempItem       =   new \common\models\RentalFeatureItem();
                                            ?>
                                            <div class="row dv_rental_feature_info_container">
                                                
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="form-group text-center">
                                                <button name="" type="button" class="btn_add_rental_feature_info btn btn-default add-landmark-btn"><span>+</span> Add New Feature</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group text-center">
                            ...
                            <?= Html::button($model->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-default red-btn ' : 'btn btn-primary gray-btn bnt_update_rental_property']) ?>
                        </div>
                    </div>
                <?php ActiveForm::end(); ?>
            </div>
