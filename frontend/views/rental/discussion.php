...
$this->title = "Rental Discussion";

$discussionArr  = DiscussionPost::find()->where(['category_id' => 2])->active()->all();
            ...
            <div class="row">
                <div class="col-sm-9">
                    <div class="buying-selling-titlebar">
                        <h2>Latest in Rental</h2>
                        <select name="">
                            <option>Latest in Rental</option>
                            <option>Popular in Rental</option>
                        </select>
                    </div>
