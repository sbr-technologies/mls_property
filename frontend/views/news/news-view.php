                            ...
                            <div class="latest-news-listing">
                                <div class="row">
                                    <div class="col-sm-3 latest-news-listing-img">
                                        <a href="<?php echo Url::to(['news/news_view','id' => $new->id]) ?>"><img src="<?= $new->photo->imageUrl ?>" alt=""></a>
                                    </div>
                                    <div class="col-sm-9 latest-news-listing-con">
                                        <p><?= $new->getReadMore($new->content); ?></p>
                                        <span>11 hours ago</span>
                                        <a href="<?php echo Url::to(['news/news_view','id' => $new->id]) ?>">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
