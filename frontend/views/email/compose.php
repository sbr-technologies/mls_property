...
$localJs = 'var tokenInputUrl = "' . urldecode(Yii::$app->urlManager->createUrl(['/contacts/search-my-contacts'])) . '";'
...
<!--                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <button name="" value="Send" class="btn btn-success" type="submit"><?= Yii::t('app', 'Send') ?></button>
                        </div>
                        <?php ActiveForm::end(); ?>
                      </div>
                    </div>
