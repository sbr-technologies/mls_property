...
//        }
        ...
        var typeItems = [], constStatuses = [], marketStatuses = [], categories = [], locationArr, city = null, state = null, zipCode = null, viewType = $('.hid_view_type').val(), sortBy = $('.sort_property_by').val();
...
//        });
        ...
        var urlPath = url + '?'+ $.param(params.filters) + '&view_type='+ viewType+ '&sort='+ sortBy;
 ...
 ********************/
    ...
    $(document).on('click', '.sell_estimate_view', function(){
        var thisLink = $(this);
        $(this).siblings().removeClass('active').end().addClass('active');
        $('.frm_search_result_page_search').find('.hid_view_type').val(thisLink.data('type'));
        $('.frm_search_result_page_search').submit();
        return false;
    });
...
//        });
        ...
        $.each($(".txt_save_search_recipient"), function() {
            ...
            filters:{min_price: $('.txt_filter_min_price').val(), max_price: $('.txt_filter_max_price').val(), bedroom: $('.txt_filter_bedroom').val(), bathroom: $('.txt_filter_bathroom').val(),
            categories: categories, prop_types: typeItems,general_features: generalItems,exterior_features: exteriorItems,interior_features: interiorItems,
...
//        this.div.setAttribute('data-address', this.address);
    ...
    HTMLMarker.prototype.draw = function(){
        ...
        this.div.onclick = function(){
            ...
            popup.style.left = position.x + 300 + 'px';
