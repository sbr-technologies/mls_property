...
$(document).ready(function(){ //alert("hi")
    ...
    $(document).on('click', '.btn_add_banner_advertisement_info', function () {
        var localInfoRowHtml = $('.dv_banner_advertisement_info_template').html().replace(/curTime/g, Math.floor(Date.now() / 1000));
        $('.dv_banner_advertisement_info_container').append(localInfoRowHtml);
    });
